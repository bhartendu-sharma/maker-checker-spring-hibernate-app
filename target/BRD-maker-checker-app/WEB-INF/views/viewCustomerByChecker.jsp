 <div id="viewAllCustomerByChecker" style="margin-top: 200px; display:none;">
<table id="myTable" class="table table-striped table-bordered table-responsive table-hover" >
  ...
  <c:forEach var="customerDto" items="${customerDtoList}">
    <tr>
      ...
      <td>
        <a href="authorizeCustomer/{customerDto.customerCode}/{customerDto.recordStatus}" class="edit edit_confirmation">Authorize</a>
        <a href="rejectCustomer/{customerDto.customerCode}/{customerDto.recordStatus}" class="delete delete_confirmation">Reject</a>
