...
<table id="myTable" class="table table-striped table-bordered table-responsive table-hover" >
  ...
  <tbody>
  <c:forEach var="customer" items="${customerLst}">
    <tr>
      ...
      <td>${customer.authorization}</td>

      <td>${customer.isActive}</td>

      <td>
        <a href="../modifycustomerform/${customer.customerCode}/${username}" class="edit edit_confirmation">modify</a>
        <a href="../deletecustomer/${customer.customerCode}/${customer.recordStatus}/${username}" class="delete delete_confirmation">Delete</a>
      </td>
    </tr>
  </c:forEach>
        </tbody>
